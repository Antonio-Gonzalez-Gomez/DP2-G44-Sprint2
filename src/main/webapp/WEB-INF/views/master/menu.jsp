...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			...
			<acme:menu-suboption code="master.menu.anonymous.task" action="http://localhost:8080/Acme-One/anonymous/task/list"/>
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.administrator" access="hasRole('Administrator')">
			...
			<acme:menu-separator/>
			<acme:menu-suboption code="master.menu.administrator.spamfilter" action="/authenticated/spamfilter/update"/>
